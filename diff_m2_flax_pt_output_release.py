...
model_size = "1b-TTT"
flax_args.weight_path = "trainstate_params::/nlp/scr/yusun/data/jiarui/easylm_ckpts/LLAMA-1B/06_30_TTT_MLP_1B/step_50000/streaming_train_state_50000"
pt_args.weight_path = "/nlp/scr/yusun/data/jiarui/easylm_to_hf_ckpts_release/LLAMA-1B/06_30_TTT_MLP_1B/hf_50000"
flax_args.model_config_update = dict(
    seq_modeling_block="ttt_mlp",
    ttt_base_lr=0.1,
    ttt_base_lr_init=0.01,
    ttt_base_lr_warmup=5000,
)
